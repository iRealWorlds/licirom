...
namespace API.Database.Migrations
{
    ...
    [Migration("20230523132444_AddProfileReviews")]
    partial class AddProfileReviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Database.Entities.ProfileReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReviewerKey");

                    b.HasIndex("TargetKey");

                    b.ToTable("ProfileReviews");
                });
            ...
            modelBuilder.Entity("API.Database.Entities.ProfileReview", b =>
                {
                    b.HasOne("API.Database.Entities.ApplicationUser", "Reviewer")
                        .WithMany("ReviewsGiven")
                        .HasForeignKey("ReviewerKey")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("API.Database.Entities.ApplicationUser", "Target")
                        .WithMany("ReviewsReceived")
                        .HasForeignKey("TargetKey")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
